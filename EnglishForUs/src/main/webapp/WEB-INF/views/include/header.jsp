...
<html>
  <head>
    <meta charset="UTF-8">
    <title>EnglishForUs | Dashboard</title>
    <meta content='width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no' name='viewport'>
    <!-- Favicon -->
    <link href="/resources/dist/img/abc.ico" rel="shortcut icon">
    <!-- Bootstrap 3.3.4 -->
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="/resources/index2.html" class="logo">
          ...
          <span class="logo-mini"><b>괡</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>EnglishForUs</b></span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="/resources/dist/img/${login.uphoto}" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">${login.uname}</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
                  <li class="user-header">
                    <img src="/resources/dist/img/${login.uphoto}" class="img-circle" alt="User Image" />
                    <p>
                      ${login.uname} - Web Developer
                      <small>Member since Jul. 2018</small>
                    </p>
                  </li>
                  <!-- Menu Body -->
                  <li class="user-body">
