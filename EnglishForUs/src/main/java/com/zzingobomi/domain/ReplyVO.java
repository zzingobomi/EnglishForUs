...
public class ReplyVO {
	...
	public String toString() {
		return "ReplyVO [idx=" + idx + ", itemidx=" + itemidx + ", replytext=" + replytext + ", regidemail="
				+ regidemail + ", regdisplayname=" + regdisplayname + ", regdate=" + regdate + ", updatedate="
				+ updatedate + ", regphotourl=" + regphotourl + ", likecnt=" + likecnt + ", badcnt=" + badcnt
				+ ", likestate=" + likestate + ", badstate=" + badstate + "]";
	}	
